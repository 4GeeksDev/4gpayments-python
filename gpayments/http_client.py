...
from gpayments import error, util, six
...
try:
    from gpayments.six.moves import urllib
except ImportError:
...
from gpayments.six.moves.urllib.parse import urlparse
...
def new_default_http_client(*args, **kwargs):
    if urlfetch:
        ...
        impl = Urllib2Client
        warnings.warn(
            "Warning: the Gpayments library is falling back to urllib2/urllib "
